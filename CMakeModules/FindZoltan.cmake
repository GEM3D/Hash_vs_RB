...
set(ZOLTAN_DIR  "/cm/shared/apps/zoltan/cuda75/openmpi-2.0.1/gcc-4.8.1/3.8.3/" )

#message("zoltan_dir" ${ZOLTAN_DIR})
...
find_path( ZOLTAN_INCLUDE_DIR zoltan.h
  ...
  /usr/include
# addeb by Dr_J
#  /cm/shared/apps/zoltan/cuda75/openmpi-2.0.1/gcc-4.8.1/3.8.3/include	
)
...
find_library( ZOLTAN_LIBRARY   
	...
	/usr/lib/zoltan
# added by Dr_J
#	/cm/shared/apps/zoltan/cuda75/openmpi-2.0.1/gcc-4.8.1/3.8.3/lib 
)

message("zoltan lib" ${ZOLTAN_LIBRARY})
message("zoltan_include" ${ZOLTAN_INCLUDE_DIR})
...
IF (NOT ZOLTAN_FOUND)
  if ( ZOLTAN_INCLUDE_DIR AND ZOLTAN_LIBRARY )
    ...
    set( ZOLTAN_FOUND NO )
    message(" Inside FindZoltan.cmake : finding Zoltan failed, please try to set the var ZOLTAN_DIR")
  endif ( ZOLTAN_INCLUDE_DIR AND ZOLTAN_LIBRARY )
ENDIF (NOT ZOLTAN_FOUND)

mark_as_advanced(
# ZOLTAN_DIR is commented out by Dr_J
  ZOLTAN_DIR
  ZOLTAN_INCLUDES
  ZOLTAN_LIBRARIES
)
...
# zoltan_dir commented out br Dr_J 
 ZOLTAN_DIR 
